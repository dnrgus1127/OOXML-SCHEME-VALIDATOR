...
describe('wordprocessing transitional compatibility', () => {
  it('rejects ST_Jc left in strict namespace and accepts it in transitional namespace', () => {
  ...
  it('rejects w:left for CT_Ind in strict namespace and accepts it in transitional namespace', () => {
    const registry = loadSchemaRegistry('document')
